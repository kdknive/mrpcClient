    ...
    <div class="op fixed left-0 right-0 top-0 bottom-0">
        <div class="login-Container bg-loginB top-0 bottom-0 left-0 right-0 fixed m-auto w-5/6 lg:w-3/6 z-50 inline-block justify-center text-center">
            ...
            <form class="form relative mx-8 md:mx-16 py-5">
                <input type="text" placeholder="Email" class="logInput bg-loginB w-full rounded-xl py-3 px-4 mt-3 mb-5 mx-auto block text-center text-base md:text-lg xl:text-2xl text-white">
                <input type="password" placeholder="Password" class="logInput bg-loginB w-full rounded-xl py-3 px-4 mt-3 mb-5 mx-auto block text-center text-base md:text-lg xl:text-2xl text-white">
